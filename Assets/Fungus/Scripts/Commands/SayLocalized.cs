...
namespace Fungus
{
    ...
    [CommandInfo("Narrative",
                 ...
                 "Writes text in a dialog box.")]
    [AddComponentMenu("")]
    public class SayLocalized : Command, ILocalizable
    {
        ...
        public override void OnEnter()
        {
            ...
            AudioClip audioTemp = voiceOverClip;
            // this should come from the localization-object itself

            voiceOverClip = Resources.Load<AudioClip>("Speech/" + GameObject.Find("GameSafe").GetComponent<Flowchart>().GetStringVariable("Language") + "/" + audioTemp.name);
            if (voiceOverClip == null) { voiceOverClip = audioTemp; }
