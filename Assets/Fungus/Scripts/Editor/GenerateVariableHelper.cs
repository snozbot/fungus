...
namespace Fungus.EditorUtils
{
    ...
    public class VariableScriptGenerator
    {
        ...
        private const string EditorDataDrawerScriptTemplate = @"// This code is part of the Fungus library (http://fungusgames.com)
// It is released for free under the MIT open source license (https://github.com/snozbot/fungus/blob/master/LICENSE)
...
{{
    ...
    {{ }}
        ...
        private const string VariableAndDataScriptTemplate = @"// This code is part of the Fungus library (http://fungusgames.com)
// It is released for free under the MIT open source license (https://github.com/snozbot/fungus/blob/master/LICENSE)
...
{{
	...
	{{
        ...
        private const string VariableOnlyScriptTemplate = @"// This code is part of the Fungus library (http://fungusgames.com)
// It is released for free under the MIT open source license (https://github.com/snozbot/fungus/blob/master/LICENSE)
...
{{
	...
	{{ }}
        ...
        private const string DataBasedPropertyScriptTemplate = @"// This code is part of the Fungus library (http://fungusgames.com)
// It is released for free under the MIT open source license (https://github.com/snozbot/fungus/blob/master/LICENSE)
...
{5}
        ...
        //6 variableProperty Type of
        //7 null check summary
        private const string VariableOnlyPropertyScriptTemplate = @"// This code is part of the Fungus library (http://fungusgames.com)
// It is released for free under the MIT open source license (https://github.com/snozbot/fungus/blob/master/LICENSE)
