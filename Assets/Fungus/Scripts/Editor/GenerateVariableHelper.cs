...
namespace Fungus.EditorUtils
{
    ...
    public class VariableScriptGenerator
    {
        ...
        const string EditorScriptLocation = ScriptLocation + "Editor/VariableTypes/";

        const string EditorDataDrawerScriptTemplate = @"/*This script has been, partially or completely, generated by the Fungus.GenerateVariableWindow*/
using UnityEditor;
using UnityEngine;
...
{{
    ...
    {{ }}
        ...
        const string VariableAndDataScriptTemplate = @"/*This script has been, partially or completely, generated by the Fungus.GenerateVariableWindow*/
using UnityEngine;
{1}
...
{{
	...
	{{
        ...
        const string VariableOnlyScriptTemplate = @"/*This script has been, partially or completely, generated by the Fungus.GenerateVariableWindow*/
using UnityEngine;
{1}
...
{{
	...
	{{ }}
        ...
        const string DataBasedPropertyScriptTemplate = @"/*This script has been, partially or completely, generated by the Fungus.GenerateVariableWindow*/
using UnityEngine;
...
{5}
        ...
        //6 variableProperty Type of
        //7 null check summary
        const string VariableOnlyPropertyScriptTemplate = @"/*This script has been, partially or completely, generated by the Fungus.GenerateVariableWindow*/
using UnityEngine;
...
{5}
        ...
        const string DataNullCheckSummary = @"
            if ({0}Data.Value == null)
            {{
                return ""Error: no {0} set"";
            }}";
        const string VariableOnlyNullCheckSummary = @"
            if ({0}Var == null)
            {{
        ...
        private void GeneratePropertyCommand()
        {
            ...
            //write to file
            Func<string> propContentOp = () => { return string.Format(generateVariableDataClass ? DataBasedPropertyScriptTemplate : VariableOnlyPropertyScriptTemplate,
