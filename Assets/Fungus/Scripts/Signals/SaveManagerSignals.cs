...
namespace Fungus
{
    ...
    public static class SaveManagerSignals
    {
        ...
        public static void DoSavePrepare(string savePointKey, string savePointDescription) { if (OnSavePrepare != null) OnSavePrepare(savePointKey, savePointDescription); }
        ...
        public static void DoSavePreLoad(string savePointKey) { if (OnSavePreLoad != null) OnSavePreLoad(savePointKey); }
        ...
        public static void DoSaveProfileChanged() { if (OnSaveProfileChanged != null) OnSaveProfileChanged(); }
    }
}
