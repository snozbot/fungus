...
namespace Fungus
{
    ...
    public class SetVariable : Command
    {
        ...
        [VariableProperty(typeof(BooleanVariable),
                          ...
                          typeof(Vector2IntVariable),
                          typeof(Vector3IntVariable))]
        ...
        [Tooltip("Vector2Int value to set with")]
        [SerializeField] protected Vector2IntData vector2IntData;

        [Tooltip("Vector3Int value to set with")]
        [SerializeField] protected Vector3IntData vector3IntData;
        ...
        protected virtual void DoSetOperation()
        {
            ...
            else if (t == typeof(Vector2IntVariable))
            {
                Vector2IntVariable vector2IntVariable = (variable as Vector2IntVariable);
                vector2IntVariable.Apply(setOperator, vector2IntData.Value);
            }
            else if (t == typeof(Vector3IntVariable))
            {
                Vector3IntVariable vector3IntVariable = (variable as Vector3IntVariable);
                vector3IntVariable.Apply(setOperator, vector3IntData.Value);
            }
        }
        ...
        public static readonly Dictionary<System.Type, SetOperator[]> operatorsByVariableType = new Dictionary<System.Type, SetOperator[]>() {
            ...
            { typeof(Vector2IntVariable), Vector2IntVariable.setOperators },
            { typeof(Vector3IntVariable), Vector3IntVariable.setOperators }
        };
        ...
        public override string GetSummary()
        {
            ...
            {
                description += vector2IntData.GetDescription();
            }
            else if (t == typeof(Vector3IntVariable))
            {
                description += vector3IntData.GetDescription();
            }
        ...
        public override bool HasReference(Variable variable)
        {
            ...
            {
                retval |= vector2IntData.vector2IntRef == variable;
            }
            else if (t == typeof(Vector3IntVariable))
            {
                retval |= vector3IntData.vector3IntRef == variable;
            }
