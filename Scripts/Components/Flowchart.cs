...
namespace Fungus
{
    ...
    public class Flowchart : MonoBehaviour, ISubstitutionHandler
    {
        ...
        public virtual Animator GetAnimatorVariable(string key)
        {
            var variable = GetVariable<AnimatorVariable>(key);
            if (variable != null)
            {
                return GetVariable<AnimatorVariable>(key).Value;
            }
            else
            {
                return null;
        ...
        public virtual void SetAnimatorVariable(string key, Animator value)
        {
            var variable = GetVariable<AnimatorVariable>(key);
            if (variable != null)
            {
        ...
        public virtual Vector2 GetVector2Variable(string key)
        {
            var variable = GetVariable<Vector2Variable>(key);
            if (variable != null)
            {
                return GetVariable<Vector2Variable>(key).Value;
            }
            else
            {
                return Vector2.zero;
        ...
        public virtual void SetVector2Variable(string key, Vector2 value)
        {
            var variable = GetVariable<Vector2Variable>(key);
            if (variable != null)
            {
        ...
        public virtual Vector3 GetVector3Variable(string key)
        {
            var variable = GetVariable<Vector3Variable>(key);
            if (variable != null)
            {
                return GetVariable<Vector3Variable>(key).Value;
            }
            else
            {
                return Vector3.zero;
        ...
        public virtual void SetVector3Variable(string key, Vector3 value)
        {
            var variable = GetVariable<Vector3Variable>(key);
            if (variable != null)
            {
        ...
        public virtual Vector2Int GetVector2IntVariable(string key)
        {
            var variable = GetVariable<Vector2IntVariable>(key);
            if (variable != null)
            {
                return GetVariable<Vector2IntVariable>(key).Value;
            }
            else
            {
        ...
        public virtual void SetVector2IntVariable(string key, Vector2Int value)
        {
            var variable = GetVariable<Vector2IntVariable>(key);
            if (variable != null)
            {
        ...
        public virtual Vector3Int GetVector3IntVariable(string key)
        {
            var variable = GetVariable<Vector3IntVariable>(key);
            if (variable != null)
            {
                return GetVariable<Vector3IntVariable>(key).Value;
            }
            else
            {
        ...
        public virtual void SetVector3IntVariable(string key, Vector3Int value)
        {
            var variable = GetVariable<Vector3IntVariable>(key);
            if (variable != null)
            {
