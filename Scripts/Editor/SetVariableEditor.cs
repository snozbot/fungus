    ...
    public class SetVariableEditor : CommandEditor
    {
        ...
        public override void OnEnable()
        {
            ...
            propertyInfoByVariableType = new Dictionary<System.Type, VariablePropertyInfo>() {
                ...
                { typeof(Vector2IntVariable), new VariablePropertyInfo("Vector2Int", serializedObject.FindProperty("vector2IntData")) },
                { typeof(Vector3IntVariable), new VariablePropertyInfo("Vector3Int", serializedObject.FindProperty("vector3IntData")) }
            };
        }
